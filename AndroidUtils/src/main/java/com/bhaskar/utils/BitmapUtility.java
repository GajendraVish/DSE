...
public final class BitmapUtility {
    ...
    /**
     * @param jsonURL
     * @param connectionTimeOutTIME               (in miliSeconds)
     * @param tempStorageForBitmapByteArrayHolder default you can provide (16*1024)
     * @param readTimeOutTIME                     (in miliSeconds)
     * @return
     */
     ...
     * @param reflectionGap                     The gap we want between the reflection and the original image
     * @param reflectedBitmapHeightInPercentage (0 to 100) height of new reflected bitmap should be % of
     *                                          original bitmap
