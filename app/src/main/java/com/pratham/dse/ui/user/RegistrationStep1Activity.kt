...
class RegistrationStep1Activity : BaseActivity(), AdapterView.OnItemClickListener{
    ...
    companion object {
        val TAG = RegistrationStep1Activity::class.java.simpleName
        fun startActivity(context: Context, bundle: Bundle?) {
            val intent = Intent(context, RegistrationStep1Activity::class.java)
            bundle?.let {
