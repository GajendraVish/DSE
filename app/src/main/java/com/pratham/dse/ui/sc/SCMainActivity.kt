...
import kotlinx.android.synthetic.main.activity_sc_main.*
import kotlinx.android.synthetic.main.app_bar_sc_main.*
import kotlinx.android.synthetic.main.content_sc_main.*
...
class SCMainActivity : BaseActivity(), NavigationView.OnNavigationItemSelectedListener {

    companion object {
        private val TAG = SCMainActivity::class.java.simpleName
        fun startActivity(context: Context, bundle: Bundle?) {
            val intent = Intent(context, SCMainActivity::class.java)
            bundle?.let {
...
//            }
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        ...
        when (item.itemId) {
            ...
            R.id.nav_profile -> {
                UpdateProfileActivity.startActivity(this@SCMainActivity,null, AppConstant.PROFILE_ACTIVITY_FLAG)
            }
